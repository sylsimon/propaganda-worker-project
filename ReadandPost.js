...
async function handlePostRequest(request) {
  const url = "https://endikr415p43u.x.pipedream.net/";
  const init = {
  ...
  let reqBody = await readRequestBody(request); //this waits for the readRequest function below: Step 2 then goes Step 3
